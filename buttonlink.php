...
<div class="container">
 ...
 <div class="row">
   ...
   <form action="form.php" method="post">
     <input type="submit" class="btn btn-primary pull-right" name="pdf" value="Generate Pdf">
  </form>
   <form action="trackorder.php">
     <input type="submit" class="btn btn-primary pull-right" value="Track" style="margin-right:10px;">
  </form> 
   </div>
 </div>
</div>
